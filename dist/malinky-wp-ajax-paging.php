 ...
 * Description: This plugin allows you to use 3 types of paging including Infinite Scroll, Ajax Pagination and an Load More Button. All  
 * paging types use ajax for a seamless user experience. This plugin works on posts, custom post types and WooCommerce. Multiple
 * pagination options can be added if you use different templates throughout your site.
 * Version: 1.0
 * Author: Malinky
